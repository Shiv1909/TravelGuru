      ...
      <section className="hero">
        <Container>
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <p>
                  ...
                  further than TravelGuru -Your ultimate travel companion.
                </p>
              </div>
            </Col>
            ...
            <Col lg="2">
              <div className="hero__img-box hero_video-box">
              <video src={heroVideo} alt="" autoPlay loop muted controls />
              </div>
            </Col>
            <Col lg="2">
      ...
      {/* <section>
        <Container>
          ...
          <Row>
            <Col lg="12" className="mb-5">
              <Subtitle subtitle={"Explore"} />
              <h2 className="featured__tour-title">Our featured Resorts</h2>
            </Col>
            <FeaturedTourList />
          </Row>
          <Row>
            <Col lg="12" className="mb-5">
              <Subtitle subtitle={"Explore"} />
              <h2 className="featured__tour-title">Our featured Vacation Spots</h2>
            </Col>
            <FeaturedTourList />
          </Row>
        </Container>
