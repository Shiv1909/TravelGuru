...
export default function About() {
  ...
  return (
    <>
      ...
      <section className="aboutTravelGuru">
        <div className="container">
          <h1>
            <span className=" small">
              We are <span className="abrilFont">TravelGuru</span>
            </span>
          </h1>
          <p>
            TravelGuru is a leading website dedicated to hotel booking around
            ...
            TravelGuru aims to provide a comfortable and memorable stay for all
            its customers.
            <br />
            <br />
            With an extensive network of hotels and resorts across the country,
            TravelGuru ensures that travelers have access to a wide range of
            options that suit their preferences and budget. From luxurious
            five-star hotels to cozy budget accommodations, TravelGuru caters to
            ...
            <br />
            <br />
            TravelGuru goes the extra mile to ensure customer satisfaction by
            ...
            Rajasthan, TravelGuru is their go-to platform for finding the ideal
            ...
            <br />
            <br />
            With TravelGuru, travelers can book their stay in India with
            ...
            unforgettable memories by staying with TravelGuru.
          </p>
        </div>
      </section>
